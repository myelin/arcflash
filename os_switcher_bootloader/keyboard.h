...
extern void keyboard_set_leds(bool scroll, bool num, bool caps);

// callbacks from keyboard
extern void keyboard_keydown(uint8_t keycode);
extern void keyboard_keyup(uint8_t keycode);
extern void keyboard_mousemove(int dx, int dy);

enum keyboard_state_t {
    KEYBOARD_INIT = 0,
    KEYBOARD_RESET,
    KEYBOARD_RESET_1,
    KEYBOARD_RESET_2,
...
extern enum keyboard_state_t keyboard_state;
